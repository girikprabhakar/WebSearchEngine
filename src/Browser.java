...
public class Browser extends JFrame {
	...
	public void search() {
		...
		if (!word.equals(searchQuery.getText())&&!searchQuery.getText().toLowerCase().equals(word.toLowerCase())) {
			addClosestWord(word);
		}
	...
	public void addSearchResult(String headingText, String linkText, String descriptionText) {
		...
		SearchResult.setMaximumSize(new Dimension(Integer.MAX_VALUE, 25 * 3));
...
//		addSearchResult("asd5","asd","asd");
		...
		gl_TopBar.setHorizontalGroup(gl_TopBar.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_TopBar.createSequentialGroup().addGroup(gl_TopBar.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING,
								gl_TopBar.createSequentialGroup().addContainerGap().addComponent(SearchResults,
						...
						.addGroup(gl_TopBar.createSequentialGroup().addGap(10).addComponent(AutoSuggestions,
								GroupLayout.DEFAULT_SIZE, 406, Short.MAX_VALUE)))
						.addContainerGap()));
		gl_TopBar.setVerticalGroup(gl_TopBar.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_TopBar.createSequentialGroup()
						.addComponent(SearchBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(AutoSuggestions, GroupLayout.PREFERRED_SIZE, 67, GroupLayout.PREFERRED_SIZE)
						.addGap(10).addComponent(SearchResults, GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)
						.addContainerGap()));
