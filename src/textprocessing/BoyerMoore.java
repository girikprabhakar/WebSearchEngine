...
//        String txt = "abacadabrabracabracadabrabrabrac-fdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdskjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgad";
        String pat="to";
        String txt="We followed the well-known and accepted procedure and guidelines by Kitchenham et. al. [14] to conduct this SLR as they \r\n"
        		+ "deem to be an appropriate way to systematically identify and qualitatively specify the criteria for the selected studies involved \r\n"
        		+ "in the review and data synthesis. In the blockchain field, the concepts, nomenclature, and terminologies have not been \r\n"
        		+ "consolidated yet. Hence, our SLR undertaking was not a linear and mechanical procedure. Instead, our review tended to be \r\n"
        		+ "hermeneutic and iterative. That is, to get immersed in the literature, as recommended by Brun et al. [40], we read introductory \r\n"
        		+ "and literature survey papers, some of which are listed in Section 3 (Table 1), t";
