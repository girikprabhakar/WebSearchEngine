...
public class SortResultsByRank {
	...
	private static HashMap<String,Integer> sortingValuesInverse(HashMap<String,Integer> map){		
		...
		//storing the sorted list in HashMap to maintain the iteration order  
	...
	public static Map<String,Integer> sortingByRank(ArrayList<String> as, String phrase) {
		HashMap<String,Integer> wordCount = new HashMap<String,Integer>();
		
		for(String fileName : as) {
			String[] words = Indexing.getStringFromFiles(new File("Webpages/"+fileName));
		...
		Map<String,Integer> sortedMap = sortingValuesInverse(wordCount);
		return sortedMap;
	}
}
